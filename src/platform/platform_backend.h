...
public:
	...
	/* Window */
	virtual bool createWindow(const char *title, int width, int height, bool fullscreen) = 0;
	virtual void destroyWindow() = 0;
	virtual bool recreateWindow(const char *title, int width, int height, bool fullscreen) = 0;
