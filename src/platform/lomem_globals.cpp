...
const LMGlobal kLowMemGlobals[] = {
	...
	{"RAMBase", 0x02B2, 4, LM_POINTER, LM_CAT_HARDWARE,
	...
	{"GZRootHnd", 0x0328, 4, LM_HANDLE, LM_CAT_SYSTEM,
	...
	{"JADBProc", 0x06B8, 4, LM_POINTER, LM_CAT_INTERRUPT,
	...
	{"WidthListHand", 0x08E4, 4, LM_HANDLE, LM_CAT_FONT,
	...
	{"CurApRefNum", 0x0900, 2, LM_WORD, LM_CAT_APP,
	...
	{"CurStackBase", 0x0908, 4, LM_POINTER, LM_CAT_APP,
	...
	{"PaintWhite", 0x09DC, 2, LM_WORD, LM_CAT_WINDOW,
	...
	{"DragHook", 0x09F6, 4, LM_POINTER, LM_CAT_WINDOW,
	...
	{"TopMapHndl", 0x0A50, 4, LM_HANDLE, LM_CAT_RESOURCE,
	...
	{"CurActivate", 0x0A64, 4, LM_POINTER, LM_CAT_WINDOW,
	 "Pointer to window to receive activate event"},
	{"CurDeactive", 0x0A68, 4, LM_POINTER, LM_CAT_WINDOW,
	...
	{"TEDoText", 0x0A70, 4, LM_POINTER, LM_CAT_TEXTEDIT,
