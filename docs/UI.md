...
Two display states plus a pre-boot model selector.  The Ctrl overlay
...
Shown when the application launches without a `--model` argument.
No emulation is running; the user picks a machine and configures it
before booting.
